							...
							<div class="col-sm">
								<div class="card">
									...
									<div class="card-body">
										...
										<a href="index.php?page=fisika&aksi=view" class="btndewe btn-success">Detail Program</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm">
								<div class="card">
									...
									<div class="card-body">
										...
										<p class="card-text" style="width: 20rem;">Deskripsi Konten</p>
										<a href="index.php?page=matematika&aksi=view" class="btndewe btn-success">Detail Program</a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 mt-md-0 mt-3 address">
					...
					<div class="social-media">
						<a href="#">
						<img src="img/ITATS.png" style="width: 30px; height: 30px;" alt="" class="img-fluid mr-4">						</a>
					</div>
