...
<body>
  ...
  <nav class="nav flex-column" style="
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="index.php?page=fisika&aksi=soal" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-expanded="false">
        Besaran dan Ukuran
      </a>
      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <div class="col-sm">
              <div class="card">
                ...
                <div class="card-body" style="background-color: rgb(100, 100, 100); color: white">
                  <h5 class="card-title">Besaran Pokok</h5>
