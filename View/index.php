...
<body>
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="#">Mata Pelajaran Umum</a>
							<a class="dropdown-item" href="#">Mata Pelajaran Kejuruan</a>
	...
	<div class="main">
		<div class="jumbotron" style="height: 900px; padding-left: 170px;">
			...
			<img src="img/Tiny student sitting on book pile and reading [Converted].png"
				...
				<div class="container">
					...
					<div class="row">
						...
						<div data-aos="fade-left">
							<div class="col-sm">
								<div class="card">
									<img src="img/Matematika.jpg" class="card-img-top"
										style="width: 32rem; height: 28rem;">
									<div class="card-body">
										<h5 class="card-title">Matematika</h5>
										<p class="card-text" style="width: 20rem;">Deskripsi Konten</p>
										<a href="#" class="btndewe btn-success">Detail Program</a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 mt-md-0 mt-3 address">
					...
					<div class="social-media">
						<a href="#">
							<img src="img/instagram.png" style="width: 30px; height: 30px;" 
